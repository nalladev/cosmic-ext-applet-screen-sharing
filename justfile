...
appid := 'io.github.nalladev.cosmic-ext-applet-screen-sharing'
...
flatpak-install: vendor-flatpak
    #!/usr/bin/env bash
    set -euo pipefail
    APP="io.github.nalladev.cosmic-ext-applet-screen-sharing"
...
flatpak-uninstall:
    flatpak uninstall --user io.github.nalladev.cosmic-ext-applet-screen-sharing
...
release version message='':
    ...
    git add resources/app.metainfo.xml flatpak/io.github.nalladev.cosmic-ext-applet-screen-sharing.json && \
